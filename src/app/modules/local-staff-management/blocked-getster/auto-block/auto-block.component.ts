...
@Component({
  selector: 'app-auto-block',
  templateUrl: './auto-block.component.html',
  styleUrls: ['./auto-block.component.scss'],
})
export class AutoBlockComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  @ViewChild('autoBlocked', { static: false }) pdfTable!: ElementRef;
  ...
  ngOnInit() {
    ...
    this._headerTitle.setTitle('Blocked GETsters');
    this.getAutoBlockedGetster();
  }
  @Input() unblock_table_ref!: NewGetsterComponent;
  //* ----------------------------  APIs Methods  --------------------------*//
  getAutoBlockedGetster() {
    this._apiService
      .getAutoBlockedGetster(this.currentPage,this.pageSize,this.cam_id)
      .subscribe((res) => {
        setTimeout(() => {
  ...
  public downloadAsPDF() {
    ...
    const htmlToPrint =
      ...
      '}' +
      '</style>';
    var printContents = document.getElementById('autoBlocked')!.innerHTML;
      ...
      '<html><head>' +
        ...
        <body onload="window.print()">
          ...
          <div style=" display: flex;flex-direction: column; width:100%">
            ...
            <span style="text-align: center;font-size:16px;color:black;font-weight:600;">Auto Blocked GETSTERs</span>
